...
\begin{figure}[H]
  ...
  \caption{
    Same as \ref{fig:smallwithlit} Histogram of the number of the different measured step heights
  }
  \label{fig:stephist}
\end{figure}
...
% higher P > bad quality (show scans for different P values)

% javi: hey guys, do you know which data is the one of the parameter optimization?
xxx
...
Our results measured an average value of $a=2,31\pm0,04$\AA~in the \ang{120} direction, and $a=2,46\pm0,03$\AA~in the \ang{60} direction (Figure~\ref{fig:atomic_resolution_measurements}). This confirms that the \ang{60} measurement does achive near-perfect precision; whereas the \ang{120} measurement (approximately parallel to the Y direction) has a substantial error of \qty{6.1}{\%}.
...
\begin{figure}[H]
  \centering
  \includegraphics[width=1\textwidth]{../resources/figures/atomic/atomic_resolution_120_plot.jpg}
  \includegraphics[width=1\textwidth]{../resources/figures/atomic/atomic_resolution_60_plot.jpg}
  \caption{Distance measurement for the \ang{120} sample (left) and the \ang{60} sample (right).\\The \ang{120} measurement had a number of N=14 points and $L=32,34\pm0,5$\AA, while the \ang{60} measurement had N=16 points and $L=39,60\pm0,5$\AA.}\label{fig:atomic_resolution_plots}
\end{figure}

\subsection{Fourier Analysis of Atomic Images}\label{sec:results_fourier}
A two dimensional Fourier transform was performed on the previously auto-corrected atomic image (Figure~\ref{fig:atomic_resolution}) using WSxM software. The result of this Fourier analysis is shown in Figure~\ref{fig:fourier_analysis}.

\begin{figure}[H]
  \centering
  \includegraphics[width=1.0\linewidth]{../resources/figures/FFT.jpg}
