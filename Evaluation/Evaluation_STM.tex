...
Our results measured an average value of $a=2,30$\AA~in the \ang{120} direction, and $a=2,44$\AA~in the \ang{60} direction (Figure~\ref{fig:atomic_resolution_measurements}). This confirms that the \ang{60} measurement does achive near-perfect precision, with an \qty{0.8}{\%} error from the literature value; whereas the \ang{120} measurement (approximately parallel to the Y direction) has a substantial error of \qty{6.5}{\%}.
