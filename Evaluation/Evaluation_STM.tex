...
\begin{figure}[H]
    ...
    \caption{
        ...
        The lateral motion follows an arc, which limits the usable scan range.
        Adapted from~\cite{ganguli2016thesis}.
    }
...
The resulting tunneling current, typically in the picoampere to nanoampere range, is far too small to be processed directly.
It is therefore fed into a converter stage, where the current is transformed into a proportional voltage signal in the millivolt range.
