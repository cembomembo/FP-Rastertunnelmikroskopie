...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.9\textwidth]{../resources/figures/graphene_reciprocal.png}
  \caption{
...
\begin{equation}
  a_{\mathrm{CC}} = \frac{4\pi}{3 \, |\vec b_1|}.
\end{equation}
\label{cc_length}
...
When this comparison is done it becomes clear that the measured step heights are not neatly allined with what is expected. However one can roughly see plateaus in the measurement data. Assuming that the calibration of the z-piezo of 10 nm/V is not completely correct, the measurement values can be multiplied by a factor that takes into account the systemetic error of a wrong calibration. In figure \ref{fig:recalibratedzpiezo} this was done with a factor of 1.7, which means that a correct calibration would have been 17 nm/V. This at does at least roughly aline some of the plateaus with the expected data.
