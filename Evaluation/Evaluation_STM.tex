...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.9\textwidth]{../resources/figures/atomic/atomic_resolution_120_plot.jpg}
  \includegraphics[width=0.9\textwidth]{../resources/figures/atomic/atomic_resolution_60_plot.jpg}
...
A two dimensional Fourier transform was performed on the previously auto-corrected atomic image (Figure~\ref{fig:atomic_resolution}) using WSxM software. The result of this Fourier analysis is shown in Figure~\ref{fig:fourier_analysis}. The measurement of the hexagon radius was determined to be $b=\unit{\angstrom}$ for the two verticaly aligned radius, and $b=\unit{\angstrom}$ for the horizontal radius.
...
As discussed in the theory the nearest-neighbor constant of HOPG can be determined from the hexagon radius of the FFT of the image (Equation~\ref{cc_length}). This results in a measurement of $a_{\mathrm{CC}} = \unit{\angstrom}$. The error was calculated using again the same method as in the previous section, taking N=2 points for every measurement.
...
We attribute the measured half values to sub-lattice periodicity and $\alpha\text{-peaks}$ being also measured. The settings and conditions under which the data was taken, such as high bias, could have contributed to this phenomena.
