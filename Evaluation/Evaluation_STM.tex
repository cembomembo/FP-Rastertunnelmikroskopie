...
After exploring the feedback behavior, we attempt to obtain atomic-resolution STM images of HOPG.\@With the present tabletop setup this is challenging, since atomic contrast typically requires an extremely sharp and stable tip apex.
...
In particular, we test different combinations of bias voltage and setpoint current, generally moving toward lower bias and higher current to reduce the tip-saample separation.
