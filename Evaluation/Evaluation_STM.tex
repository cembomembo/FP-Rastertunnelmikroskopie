...
\begin{figure}[H]
  \centering
  \includegraphics[width=0.6\textwidth]{../resources/figures/atomic/atomic_resolution.jpg}
  \caption{Auto-Correlation processed image of the LDOS of HOPG with atomic resolution. \\ The single 2D layer of the lattice is clearly visible.}\label{fig:atomic_resolution}
\end{figure}
...
\begin{figure}[H]
  ...
  \caption{Cross-Correlation processed images of the LDOS of HOPG with atomic resolution.\\The left image corresponds to the \ang{120} measurement, and the right to the \ang{60} measurement.}\label{fig:atomic_resolution_measurements}
\end{figure}
...
Furthermore, auto-correlation and cross-correlation processing analysis proved highly effective, confirming an accurate lattice constant of $\qty{2.46}{\angstrom}$ by yielding clearer images and measurements than the raw data (Figures~\ref{fig:atomic_resolution_measurements} and~\ref{fig:atomic_resolution_plots}).
