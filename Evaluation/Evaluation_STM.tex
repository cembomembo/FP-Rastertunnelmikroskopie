...
This is the result of the thermal drift and piezo creep of the temperature at which the experiment was executed.

that the actual piezoelectric response was asymmetric, likely due to thermal drift or uncorrected creep, which the software's default calibration did not account for.
